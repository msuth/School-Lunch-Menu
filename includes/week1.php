...
// Retrieve all the data from the "Week 1" table
$Week1Meals = mysql_query("SELECT * FROM Lunch WHERE Week=1 ORDER BY Date")
or die(mysql_error());  

echo "<table class='LunchTableStyle table table-bordered table-striped' cellspacing='0' cellpadding='0' width='100%'>";
echo "<tr> <th width='15%' style='text-align:center; background:#fff; border-top:solid 1px #fff; border-left:solid 1px #fff;'></th> <th style='text-align:center;'>Main Course 1</th> <th style='text-align:center;'>Main Course 2</th> <th style='text-align:center;'>Dessert</th> </tr>";
// keeps getting the next row until there are no more to get
while($row = mysql_fetch_array( $Week1Meals )) {
